...
/** Страница просмотра карточки тикета (неавторизированный пользователь) при создании */
...
//                "descriptionLabel = %s-----------------------------------------------\n" +
//                "description = %s--------------------------------------------------\n",
//                queue.getText(),email.getText(),priority.getText(),descriptionLabel.getText(),description.getText());
